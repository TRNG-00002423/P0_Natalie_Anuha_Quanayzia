...
e6 = Expense.objects.create(user_id=alice, amount=89.50, description='Hotel night', category='LODGING', created_date=timezone.now())
e7 = Expense.objects.create(user_id=carol, amount=250.00, description='Standing desk', category='OFFICE', created_date=timezone.now())
e8 = Expense.objects.create(user_id=carol, amount=60.00, description='Team breakfast', category='MEALS', created_date=timezone.now())
e9 = Expense.objects.create(user_id=carol, amount=180.00, description='Airport hotel', category='LODGING', created_date=timezone.now())
e10 = Expense.objects.create(user_id=dave, amount=32.40, description='Notebooks and pens', category='OFFICE', created_date=timezone.now())
e11 = Expense.objects.create(user_id=dave, amount=410.00, description='Train tickets', category='TRAVEL', created_date=timezone.now())
e12 = Expense.objects.create(user_id=dave, amount=27.00, description='Coffee run', category='MEALS', created_date=timezone.now())
